<template>
      ...
      <div class="pt-6">
        ...
        <div class="mx-auto max-w-2xl px-4 pb-4 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-4 lg:pt-16">
          ...
          <div class="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p class="text-3xl tracking-tight text-gray-900">{{ $t('global.currency') + product.price }}</p>
            ...
            <div class="mt-6">
              ...
              <div class="flex items-center">
                ...
                <a :href="reviews.href" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ reviews.totalCount }} {{ $t('details.kennel_reviews') }}</a>
              </div>
            </div>
   ...
   -->
          ...
          <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div class="mt-10">
              <h3 class="text-sm font-medium text-gray-900">Detalhes</h3>
  ...
  const { product, reviews } = fetchPetFromId(id)
